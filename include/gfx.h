...
#define GXY_AUTO_GL(M, m,ethod) \
 ...
 \ inline Ret m##ethod (Args&&... args)
 \ {
 \   const Ret ret = gl##M##ethod (std::forward<Args>(args)...);
 \   assert(glGetError() == GL_NO_ERROR);
 \
 \   return ret;
 \ }
...
GXY_AUTO_GL(C, c,reateProgram)
GXY_AUTO_GL(C, c,reateShader)
...
GXY_AUTO_GL(G, g,etAttribLocation)
...
GXY_AUTO_GL(G, g,etUniformLocation)
...
GXY_AUTO_GL(I, i,sProgram)
GXY_AUTO_GL(I, i,sShader)
...
GXY_AUTO_GL(G, g,etFragDataLocation)
...
GXY_AUTO_GL(G, g,etStringi)
GXY_AUTO_GL(I, i,sRenderbuffer)
...
GXY_AUTO_GL(G, g,etUniformBlockIndex)
...
GXY_AUTO_GL(F, f,enceSync)
GXY_AUTO_GL(I, i,sSync)
GXY_VOID_GL(D, d,eleteSync)
GXY_AUTO_GL(C, c,lientWaitSync)
...
GXY_AUTO_GL(G, g,etFragDataIndex)
GXY_VOID_GL(G, g,enSamplers)
GXY_VOID_GL(D, d,eleteSamplers)
GXY_AUTO_GL(I, i,sSampler)
...
GXY_AUTO_GL(G, g,etSubroutineUniformLocation)
GXY_AUTO_GL(G, g,etSubroutineIndex)
...
GXY_AUTO_GL(I, i,sTransformFeedback)
...
GXY_AUTO_GL(G, g,etProgramResourceIndex)
GXY_VOID_GL(G, g,etProgramResourceName)
GXY_VOID_GL(G, g,etProgramResourceiv)
GXY_AUTO_GL(G, g,etProgramResourceLocation)
GXY_AUTO_GL(G, g,etProgramResourceLocationIndex)
...
GXY_AUTO_GL(G, g,etDebugMessageLog)
...
GXY_AUTO_GL(U, u,nmapNamedBuffer)
...
GXY_AUTO_GL(C, c,heckNamedFramebufferStatus)
...
GXY_AUTO_GL(G, g,etGraphicsResetStatus)
...
GXY_AUTO_GL(G, g,etTextureHandleARB)
GXY_AUTO_GL(G, g,etTextureSamplerHandleARB)
GXY_VOID_GL(M, m,akeTextureHandleResidentARB)
GXY_VOID_GL(M, m,akeTextureHandleNonResidentARB)
GXY_AUTO_GL(G, g,etImageHandleARB)
...
GXY_AUTO_GL(I, i,sTextureHandleResidentARB)
GXY_AUTO_GL(I, i,sImageHandleResidentARB)
GXY_VOID_GL(V, v,ertexAttribL1ui64ARB)
GXY_VOID_GL(V, v,ertexAttribL1ui64vARB)
GXY_VOID_GL(G, g,etVertexAttribLui64vARB)
GXY_AUTO_GL(C, c,reateSyncFromCLeventARB)
...
GXY_AUTO_GL(G, g,etDebugMessageLogARB)
...
GXY_AUTO_GL(G, g,etGraphicsResetStatusARB)
...
GXY_AUTO_GL(I, i,sNamedStringARB)
